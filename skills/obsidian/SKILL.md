---
name: obsidian
description: "Automate Obsidian vaults with obsidian-cli"
...
## Direct file operations (no obsidian-cli needed)

For simple operations, work directly with `.md` files in the vault. Obsidian auto-detects changes.
