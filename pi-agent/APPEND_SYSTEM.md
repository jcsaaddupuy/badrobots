...
- **DO NOT BE OVERLY VERBOSE** - Be concise in code and communication. Avoid generating too much markdown files.
...
- Use todos, organized as parralelizable tasks.
- Update your memories following memory best practices.
